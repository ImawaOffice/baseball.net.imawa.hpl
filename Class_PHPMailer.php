...
class Class_PHPMailer {
	...
	public function __construct() {
		...
		$this->Log->notice( "SMTP HOST: {$SMTP_Host}, Port: {$SMTP_Port}, Secure: {$SMTP_Secure}", __FUNCTION__, basename( __FILE__ ) );
		...
		$this->Log->notice( "SMTP From: {$MAIL_FromAddress}, FromName: {$MAIL_FromName}", __FUNCTION__, basename( __FILE__ ) );
	...
	public function sendMail( $to, $subject, $body, $cc = null, $bcc = null ) {
		...
		$this->Log->notice( "To: $to, Subject: $subject, Body: $body, CC: $cc, BCC: $bcc", __FUNCTION__, basename( __FILE__ ) );
