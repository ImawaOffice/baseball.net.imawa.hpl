						...
						<table class="table" id="ruleTable">
							...
							<tbody>
								<tr>
									...
									<td><?php echo htmlspecialchars( getAttachmentFile( 11 ) ); ?></td>
									<td class="text-center"><button type="submit" class="update_button" name="upload_button" value="11">アップロード</button></td>
								</tr>
<!--
								<tr>
									<td>試合結果</td>
									<td><input type="file" id="filename_result" name="filename_result" value="" accept=".pdf" ></td>
									<td><?php echo htmlspecialchars( getAttachmentFile( 12 ) ); ?></td>
									<td class="text-center"><button type="submit" class="update_button" name="upload_button" value="12">アップロード</button></td>
								</tr>
-->
							</tbody>
						</table>
