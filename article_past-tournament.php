...
function getPastTournaments(){
	...
	global $g_Log;
	$g_Log->notice( "過去大会データの取得", __FUNCTION__, basename( __FILE__ ) );
			...
			<div class="past-tournament-content">
				...
				?>
						<div class="tournament-item">
							<a class="tournament-link" href="./tournamentresults?tournament_id=<?php echo $tournamentId; ?>"><?php echo "$tournamentTitle $tournamentText"; ?></a>
						</div>
				<?php
					}
				?>
