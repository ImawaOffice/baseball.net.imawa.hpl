						...
						<table class="table" id="ruleTable">
							...
							<tbody>
								<tr>
									...
									<td><?php echo htmlspecialchars( getAttachmentFile( 41 ) ); ?></td>
									<td class="text-center"><button type="submit" class="update_button" name="upload_button" value="41">アップロード</button></td>
								</tr>
								<tr>
									<td>試合結果</td>
									<td><input type="file" id="filename_result" name="filename_result" value="" accept=".pdf" ></td>
									<td><?php echo htmlspecialchars( getAttachmentFile( 42 ) ); ?></td>
									<td class="text-center"><button type="submit" class="update_button" name="upload_button" value="42">アップロード</button></td>
								</tr>
							</tbody>
						</table>
					</div>
