			...
			<form method="post" action="" enctype="multipart/form-data" >
				...
				<div class="teamdetail">
						...
						<table class="table" id="ruleTable">
							...
							<tbody>
								<tr>
									...
									<td><?php echo htmlspecialchars( getAttachmentFile( 31 ) ); ?></td>
									<td class="text-center"><button type="submit" class="update_button" name="upload_button" value="31">アップロード</button></td>
								</tr>
								<tr>
									<td>試合結果</td>
									<td><input type="file" id="filename_result" name="filename_result" value="" accept=".pdf" ></td>
									<td><?php echo htmlspecialchars( getAttachmentFile( 32 ) ); ?></td>
									<td class="text-center"><button type="submit" class="update_button" name="upload_button" value="32">アップロード</button></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class=form-group>
						...
						<input type="text" id="access_code" name="access_code" value="<?php echo ( isset( $_SESSION[ 'RES_ACCESS_CODE' ] ) ) ? $_SESSION[ 'RES_ACCESS_CODE' ] : ''; ?>"  >
					...
					<table class="table" id="gameTable">
						...
						<tbody>
							<?php foreach ( getGameList2( $_SESSION[ 'FROM_TOURNAMENT_ID' ], isset( $_SESSION[ 'RES_ACCESS_CODE' ] ) ? $_SESSION[ 'RES_ACCESS_CODE' ] : '', isset( $_SESSION[ 'FORM_PAGE_CURRENT' ] ) ? $_SESSION[ 'FORM_PAGE_CURRENT' ] : 1, isset( $_SESSION[ 'FORM_PAGE_ROWS' ] ) ? $_SESSION[ 'FORM_PAGE_ROWS' ] : 10 ) as $game ) : ?>
								<tr 
