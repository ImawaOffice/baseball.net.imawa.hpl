...
function setConfig_DDL( $p_SQLFile = null ) {
	...
	global $g_Log;
	$g_Log->notice( "設定データベース", __FUNCTION__, basename( __FILE__ ) );
	...
	try {
		...
		$g_Log->notice( "{$p_SQLFile}を実行しました", __FUNCTION__, basename( __FILE__ ) );
...
function setDB_DDL( $p_SQLFile = null ) {
	...
	global $g_Log;
	$g_Log->notice( "DDL実行", __FUNCTION__, basename( __FILE__ ) );
...
function setDB_DML( $p_SQLFile = null ) {
	...
	global $g_Log;
	$g_Log->notice( "DML実行", __FUNCTION__, basename( __FILE__ ) );
