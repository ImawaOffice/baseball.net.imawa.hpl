...
function getMenuId( $p_menuName = "" ){
	...
	global $g_Log;
	$g_Log->debug( "親メニューIDの取得 : " . $p_menuName, __FUNCTION__, basename( __FILE__ ) );
...
function getMenu( $p_menuParentId = 0 ) {
	...
	$g_Log->debug( "メニュー情報の再帰取得 : " . $p_menuParentId, __FUNCTION__, basename( __FILE__ ) );
