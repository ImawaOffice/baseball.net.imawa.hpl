			...
			<form method="post" action=""  >
				...
				<div class="maintenanceForm">
					...
					<div class=form-group>
						...
						<select id="team1_id" name="team1_id">
							<?php foreach ( getGameUnsetTeamList( $_SESSION[ 'RES_TOURNAMENT_ID' ] ) as $team ) : ?>
								<option 
				...
				<div class="teamdetail">
					...
					<table class="table" id="gameTable">
						...
						<tbody>
							<?php foreach ( getGameList( $_SESSION[ 'RES_TOURNAMENT_ID' ], $_SESSION[ 'RES_PAGE_CURRENT' ], $_SESSION[ 'RES_PAGE_ROWS' ] ) as $game ) : ?>
								<tr 
