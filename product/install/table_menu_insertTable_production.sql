...
( 1100, 1000, 1100,  00, 9999, '監督メニュー', '#', 1, 'system', 'system' ),
( 1101, 1100, 1101,  00, 9999, '試合結果登録', './gamemaintenance', 1, 'system', 'system' ),
( 1200, 1000, 1200, 000, 9999, '本部メニュー', '#', 1, 'system', 'system' ),
( 1201, 1200, 1201, 000, 9999, '大会登録', './tournamentmaintenance', 1, 'system', 'system' ),
( 1202, 1200, 1202, 000, 9999, '参加チーム登録', './teammaintenance', 1, 'system', 'system' ),
( 1203, 1200, 1203, 000, 9999, '試合登録', './gamematch', 1, 'system', 'system' ),
( 1204, 1200, 1204, 000, 9999, '試合日程登録', './gameschedule', 1, 'system', 'system' ),
( 1205, 1200, 1205, 000, 9999, '試合結果登録', './gamemaintenance', 1, 'system', 'system' ),
( 1206, 1200, 1206, 000, 9999, '問合せ一覧', './contactlist', 1, 'system', 'system' ),
...
( 2100, 2000, 2100,  00, 9999, '試合結果登録', './gamemaintenance', 1, 'system', 'system' ),
( 2110, 2000, 2110, 000, 9999, '大会登録', './tournamentmaintenance', 1, 'system', 'system' ),
( 2120, 2000, 2120, 000, 9999, '参加チーム登録', './teammaintenance', 1, 'system', 'system' ),
( 2130, 2000, 2130, 000, 9999, '試合登録', './gamematch', 1, 'system', 'system' )
;