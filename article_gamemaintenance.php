			...
			<form method="post" action=""  >
				...
				<div class="teamdetail">
					...
					<table class="table" id="gameTable">
						...
						<tbody>
							<?php foreach ( getGameList2( $_SESSION[ 'FROM_TOURNAMENT_ID' ], $_SESSION[ 'RES_ACCESS_CODE' ], $_SESSION[ 'FORM_PAGE_CURRENT' ], $_SESSION[ 'FORM_PAGE_ROWS' ] ) as $game ) : ?>
								<tr 
